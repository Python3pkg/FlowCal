# -*- coding: utf-8 -*-
#
# FlowCal documentation build configuration file, created by
...
# Import FlowCal to pull the version number
import FlowCal

# If extensions (or modules to document with autodoc) are in another directory,
# add these directories to sys.path here. If the directory is relative to the
# documentation root, use os.path.abspath to make it absolute, like shown here.
sys.path.insert(0, os.path.abspath('../FlowCal'))
...
version = FlowCal.__version__
# The full version, including alpha/beta/rc tags.
release = FlowCal.__version__
...
# The following is added such that the custom css is loaded
def setup(app):
